...
``` bash
 & "C:\Program Files (x86)\Windows Kits\10\bin\10.0.26100.0\x64\makeappx.exe" pack /d "C:\MSIX\My-Technician" /p "C:\MSIX\My-Technician.msix" /o

```

``` bash
& "C:\Program Files (x86)\Windows Kits\10\bin\10.0.26100.0\x64\signtool.exe" sign /f TechnicianPublisher.pfx /p password123 /fd SHA256 My-Technician.msix
```

``` bash
Add-AppxPackage -Path "C:\MSIX\My-Technician.msix"
```
